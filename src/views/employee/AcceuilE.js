  ...
  return (
    <>
      ...
      <main style={{ minHeight: "100vh", background: "#f8fafc" }}>
        <div style={{ background: "linear-gradient(135deg, #0f172a 0%, #2e1065 60%, #1e293b 100%)", padding: "64px 24px 80px", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "absolute", bottom: -40, left: -40, width: 200, height: 200, borderRadius: "50%", background: "rgba(109,40,217,0.06)", filter: "blur(40px)", pointerEvents: "none" }} />

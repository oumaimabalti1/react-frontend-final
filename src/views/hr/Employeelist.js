...
export default function Employeelist() {
  ...
  const input = { width: "100%", padding: "10px 14px", borderRadius: 10, border: "1.5px solid #e2e8f0", fontSize: 14, color: "#0f172a", outline: "none", background: "#f8fafc", boxSizing: "border-box" };
    ...
    <>
      ...
      <main style={{ minHeight: "100vh", background: "#f8fafc" }}>
        ...
        <div style={{ background: "#fff", borderBottom: "1px solid #e2e8f0", padding: "48px 24px 60px", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ maxWidth: 900, margin: "0 auto", position: "relative" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
              <div>
                <h1 style={{ fontSize: "clamp(24px,4vw,40px)", fontWeight: 800, color: "#0f172a", margin: "0 0 8px" }}>Gestion des Employés</h1>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 24px 60px", position: "relative", zIndex: 2 }}>
          ...
          {/* Form */}
          {showForm && (
            <div style={{ background: "#fff", borderRadius: 20, padding: "28px 32px", border: "1px solid #f1f5f9", marginBottom: 24, border: "1px solid #e8edf5" }}>
          ...
          <div style={{ background: "#fff", borderRadius: 20, border: "1px solid #f1f5f9", overflow: "hidden" }}>
            <div style={{ padding: "20px 24px", borderBottom: "1px solid #f1f5f9", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <h2 style={{ fontSize: 16, fontWeight: 700, color: "#0f172a", margin: 0 }}>Liste des employés</h2>
                    ...
                    <tr key={emp._id} style={{ borderTop: "1px solid #f1f5f9", background: i % 2 === 0 ? "#fff" : "#fafbfc" }}>
                      <td style={{ padding: "14px 24px" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                          <div style={{ width: 36, height: 36, borderRadius: "50%", background: "#0891b2", boxShadow: "0 2px 8px rgba(8,145,178,0.3)", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontWeight: 700, fontSize: 14 }}>
                            {(emp.name || "?")[0].toUpperCase()}
                          </div>
                          <span style={{ fontWeight: 600, color: "#0f172a", fontSize: 14 }}>{emp.name}</span>
                        </div>
                      </td>
                      <td style={{ padding: "14px 24px", color: "#64748b", fontSize: 14 }}>{emp.email}</td>
                      <td style={{ padding: "14px 24px" }}>
                        <span style={{ background: "#eff6ff", color: "#2563eb", borderRadius: 8, padding: "4px 12px", fontSize: 12, fontWeight: 600 }}>{emp.departement || "—"}</span>
                      </td>
                    </tr>
                  ))}
                </tbody>

...
export default function Register() {
  ...
  const inputWrap = (focused) => ({
    ...
    border: `1.5px solid ${focused ? "#3b82f6" : "rgba(255,255,255,0.12)"}`,
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              <div style={inputWrap()}>
                ...
                <input type="text" placeholder="Votre nom" value={form.name} onChange={e => set("name", e.target.value)} required style={inputStyle} />
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              <div style={inputWrap()}>
                ...
                <input type="email" placeholder="vous@exemple.com" value={form.email} onChange={e => set("email", e.target.value)} required style={inputStyle} />
            ...
            <div style={{ marginBottom: 8 }}>
              ...
              <div style={inputWrap()}>
                ...
                <input type={showPw ? "text" : "password"} placeholder="••••••••" value={form.password} onChange={e => set("password", e.target.value)} required style={inputStyle} />
            ...
            <div style={{ marginBottom: 28 }}>
              ...
              <div style={inputWrap()}>
                <KeyRound size={16} color="rgba(255,255,255,0.4)" />
                <input type={showConfirm ? "text" : "password"} placeholder="••••••••" value={form.confirm} onChange={e => set("confirm", e.target.value)} required style={inputStyle} />

...
export default function AcceuilC() {
  ...
  return (
    <>
      <CNavbar />
      <main style={{ minHeight: "100vh", background: "var(--gray-13)" }}>
        <div style={{ background: "linear-gradient(135deg, var(--navy-1) 0%, var(--navy-6) 60%, var(--navy-2) 100%)", padding: "64px 24px 80px", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ maxWidth: 860, margin: "0 auto", position: "relative" }}>
            <span style={{ display: "inline-block", background: "rgba(8,145,178,0.15)", color: "var(--cyan-3)", borderRadius: 20, padding: "5px 16px", fontSize: 12, fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 20 }}>
              Portail Candidat
            </span>
            <h1 style={{ fontSize: "clamp(28px, 5vw, 48px)", fontWeight: 800, color: "var(--white)", margin: "0 0 16px", lineHeight: 1.2 }}>

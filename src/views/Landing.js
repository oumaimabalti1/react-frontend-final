...
import { LogIn, UserPlus, Shield, Users, Briefcase, Bot, FileSearch, Sparkles } from "lucide-react";
    ...
    <>
      ...
      <main style={{ minHeight: "100vh", background: "#ffffff" }}>
        ...
        <div style={{
          ...
          display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 80, alignItems: "center", minHeight: "85vh"
        }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: 24 }}>
              {[
                { icon: Shield, label: "Données protégées (JWT + bcrypt)" },
                { icon: Users,  label: "5 rôles utilisateurs" },
              ].map(({ icon: Icon, label }) => (
                <div key={label} style={{
                  display: "flex", alignItems: "center", gap: 6,
          ...
          <div style={{
            ...
            <Link to="/auth/login" style={{ textDecoration: "none", display: "block", marginBottom: 12 }}>
              <button style={{
                width: "100%", padding: "14px", borderRadius: 12, border: "none",
                background: "#0891b2", color: "#fff", fontWeight: 700, fontSize: 15,
                cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8,
                boxShadow: "0 4px 16px rgba(8,145,178,0.3)", transition: "transform 0.15s"
              }}
            ...
            <Link to="/auth/register" style={{ textDecoration: "none", display: "block", marginBottom: 28 }}>
              <button style={{
                ...
                color: "#475569", fontWeight: 700, fontSize: 15, cursor: "pointer",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
              ...
              <span style={{ fontSize: 11, color: "#94a3b8", fontWeight: 600, textTransform: "uppercase" }}>Sécurisé</span>
              <div style={{ flex: 1, height: 1, background: "#e2e8f0" }} />
            </div>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: 20 }}>
              {[
                ...
                <div key={label} style={{ display: "flex", alignItems: "center", gap: 5, color: "#94a3b8", fontSize: 12 }}>
                  <Icon size={13} /> {label}
                </div>
              ))}
            </div>

    ...
    <>
      <nav style={{ position:"fixed",top:0,left:0,right:0,zIndex:1000,background:"#b6d7df",backdropFilter:"blur(16px)",borderBottom:"1px solid #e2e8f0",height:64,display:"flex",alignItems:"center",padding:"0 24px",justifyContent:"space-between" }}>
        <Link to="/employee/accueil" style={{ display:"flex",alignItems:"center",gap:10,textDecoration:"none" }}>
          ...
          <span style={{ fontSize:11,fontWeight:700,color:ACCENT,textTransform:"uppercase",letterSpacing:"0.12em",background:"#f0fdfa",border:"1px solid #99f6e4",padding:"2px 8px",borderRadius:4 }}>Employé</span>
        </Link>
        ...
        <div style={{ display:"flex",alignItems:"center",gap:2 }}>
          {links.map(({ to, label, icon: Icon }) => {
            ...
            return (
              <Link key={to} to={to} style={{ display:"flex",alignItems:"center",gap:6,padding:"7px 12px",borderRadius:8,fontSize:13,fontWeight:active?700:600,textDecoration:"none",color:active?ACCENT:"#64748b",background:active?"#f0fdfa":"transparent",transition:"all 0.15s" }}>
                <Icon size={15} /> {label}
              </Link>
            );
          })}
        ...
        <div style={{ display:"flex",alignItems:"center",gap:10 }}>
          <Link to="/profile" style={{ width:34,height:34,borderRadius:10,background:"#f0fdfa",display:"flex",alignItems:"center",justifyContent:"center",color:ACCENT,fontWeight:700,fontSize:12,textDecoration:"none" }}>E</Link>
